...
Ejemplo de salida:
```csv
"ID_PLATAFORMA","DIR3","CIF","Contract Folder Id","CPV","Title","Date","Total Amount","Id","URI","Tender Name/Document Hash/Filename"
...
- [Comunidad Foral de Navarra](https://portalcontratacion.navarra.es/es/) -> **NO** agrega los datos a PLACSP
    - [Datos abiertos](https://datosabiertos.navarra.es/dataset/anuncios-licitaciones)
- [Pais Vasco](https://www.contratacion.euskadi.eus/) -> Agrega los datos a PLACSP-
